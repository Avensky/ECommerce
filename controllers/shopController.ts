...
exports.createSession = async (req:any, res:any) => {
...
exports.updateSession = async(req:any, res:any, session:any) => {
    // TODO: fill me in
    ...
    let line_items = sessionRetrieve.line_items.data.map( (item:any) => {
        let line_item = {
            id                        : item.id,
            object                    : item.object,
...
exports.fulfillOrder = (req:any, res:any, session:any) => {
...
exports.emailCustomerAboutFailedPayment = (req:any, session:any) => {
    //console.log('session',session)
