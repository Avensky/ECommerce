...
const Auth = props => {
    ...
    switch (auth) {
        case 'login': 
            ...
            button = <div className={classes.BtnDiv}>
                <span className={['fa fa-sign-in'].join(' ')}></span> Sign In
            </div>;
            !props.loading
                ? socialAuth = <>
                    <br />
        ...
        case 'reset-password': 
            ...
            button = <NavLink to='/resetPassword'><div className={classes.BtnDiv}><span className={['fa fa-user'].join(' ')}></span>Reset Password</div></NavLink>;
            break;
    };
